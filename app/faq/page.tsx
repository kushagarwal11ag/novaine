...
export default function FaqPage() {
  const faqs = [
    ...
    {
      q: 'How can I become an authorized dealer in my city?',
      a: 'You can fill out our online Dealership Application Form or contact our sales director directly on WhatsApp at +91 87582 16246.'
    }
  ];
    ...
    <div>
      <div className="bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 text-white py-14 text-center border-b border-gray-800">
        <div className="max-w-2xl mx-auto px-4">
          <span className="text-xs font-bold uppercase tracking-widest text-novaine-yellow">Support & Help</span>
          <h1 className="text-3xl sm:text-4xl font-black text-white mt-2">
            Frequently Asked <span className="text-novaine-yellow">Questions</span>
          </h1>
          <p className="text-xs sm:text-sm text-gray-300 mt-2">
            Everything you need to know about Novaine Bikes by V&U Industries Ludhiana.
          </p>
        </div>
      </div>
