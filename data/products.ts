...
export const PRODUCTS: Product[] = [
	...
	// Ranger / Adult Models (24T, 26T)
	{
		...
		imageSide: "/assets/images/bicycle/maxx-blu.jpg",
		imageFront: "/assets/images/bicycle/maxx-blu.jpg",
		colors: [
			{
				name: "Peacock Blue",
				hex: "#00a4b4",
				imgSide: "/assets/images/bicycle/maxx-blu.jpg",
				imgFront: "/assets/images/bicycle/maxx-blu.jpg",
			},
			{
				name: "Crimson Red",
				hex: "#B91C1C",
				imgSide: "/assets/images/bicycle/maxx-red.jpg",
				imgFront: "/assets/images/bicycle/maxx-red.jpg",
			},
			{
				name: "Sea Green",
				hex: "#37F5FB",
				imgSide: "/assets/images/bicycle/maxx-sgrn.jpg",
				imgFront: "/assets/images/bicycle/maxx-sgrn.jpg",
			},
		],
		isPopular: true,
		tag: "Flagship Ranger",
	...
	},
	{
		...
		imageSide: "/assets/images/bicycle/alpha-sgrn.jpg",
		imageFront: "/assets/images/bicycle/alpha-sgrn.jpg",
		colors: [
			{
				name: "Neon Yellow / Black",
				hex: "#FACC15",
				imgSide: "/assets/images/bicycle/alpha-ylw.jpg",
				imgFront: "/assets/images/bicycle/alpha-ylw.jpg",
			},
			{
				name: "Electric Cyan",
				hex: "#06B6D4",
				imgSide: "/assets/images/bicycle/alpha-sgrn.jpg",
				imgFront: "/assets/images/bicycle/alpha-sgrn.jpg",
			},
		],
		isPopular: true,
		tag: "Popular Ranger",
